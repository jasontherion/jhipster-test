...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 29765 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 4955 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 30370 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 18754 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 11673 };
      job.tasks = [task];
      const employee: IEmployee = { id: 26886 };
      job.employee = employee;
