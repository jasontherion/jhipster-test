...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 5203 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 13624 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 16802 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 3585 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 9914 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 9223 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 7976 };
      jobHistory.job = job;
      const department: IDepartment = { id: 26598 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 18822 };
      jobHistory.employee = employee;
